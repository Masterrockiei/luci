...
from plugins.botx import bot
from pyrogram import filters, types
import os

max_file = 30641629

@bot.on_message(filters.audio | filters.video | filters.voice & filters.command("find"))
async def voice_handler(bot, message):
